...
class QoAlert extends StatefulWidget {
  ...
  const QoAlert({super.key, required this.ware, required this.guest});
  @override
         ...
         SizedBox(
           ...
           child: Column(
            ...
            children: <Widget>[
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child:  Text(cGuest == 0?'Общий':'$cGuest',
                          style: cGuest == 0? const TextStyle(
              ...
              const Text('Выберите кол-во порций и курс',
                  style: TextStyle(
                    color: Colors.black45,
                    fontSize: 12,
                    fontFamily: "Montserrat",
                    ...
                    TextButton(
                        onPressed: () {
                          ...
                          if (qnty < 0) {
                            ...
                            Navigator.pop(context, [qnty, kurs, cGuest]);
                          }
                        },
                        child: const Text(
                          "Сохранить",
